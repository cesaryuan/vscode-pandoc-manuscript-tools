...
- DOCX and Papper HTML preview buttons in the editor title for Markdown files inside a detected manuscript project when `uvx` is installed. DOCX requires saving; HTML preview can render the current unsaved buffer.
